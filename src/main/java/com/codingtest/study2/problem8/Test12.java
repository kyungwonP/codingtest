...
public class Test12 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Test12().solution(n, m, boxes));
    }

    private int solution(int n, int m, int[][] boxes) {
        int result = 0;
        ...
        while (!queue.isEmpty() && zeroCount != 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                for (int j = 0; j < 4; j++) {
                    ...
                    if (isValid(n, m, boxes, visited, nextRow, nextCol)) {
        ...
        result = zeroCount == 0 ? result : -1;

        return result;
    }

    private boolean isValid(int n, int m, int[][] boxes, boolean[][] visited, int nextRow, int nextCol) {
