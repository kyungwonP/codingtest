...
public class Test3GPT {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Test3GPT().solution(count, sequenceCount, line));
    }
    ...
    private int solution(int count, int sequenceCount, String line) {
        ...
        for (int i = sequenceCount; i < count; i++) {
            sum += Integer.parseInt(numbers[i]) - Integer.parseInt(numbers[i - sequenceCount]);
