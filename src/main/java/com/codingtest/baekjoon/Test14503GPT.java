...
public class Test14503GPT {
    ...
    private static boolean isBack(Robot robot) {
        ...
        return !isWall(backRobot.r, backRobot.c);
    }
    ...
    private static Robot go(Robot robot) {
        robot.r += GO_ROWS[robot.d];
        robot.c += GO_COLS[robot.d];
        return robot;
    }

    // 후진
    private static Robot back(Robot robot) {
        robot.r += BACK_ROWS[robot.d];
        robot.c += BACK_COLS[robot.d];
        return robot;
    }
}
